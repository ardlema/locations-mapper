...
class UTMToLatitudeLongitudeConverterSpec extends FunSpec with Matchers {
  ...
  describe("The UTM converter") {
    ...
    it("should convert UTM coordinates to latitude/longitude") {
      val expectedCoordinates = Coordinates("40.41527701272302", "-3.7134030732037786")
      val coordinates = UTMToLatitudeLongitudeConverter.utm2LatitudeLongitude("30 T 439474.372756695 4474094.8493885")
...
object UTMToLatitudeLongitudeConverter {
  ...
  def utm2LatitudeLongitude(utm: String): Coordinates = {
    val parts = utm.split(" ")
    val zone = parts(0).toInt
    val letter = parts(1).toUpperCase.charAt(0)
